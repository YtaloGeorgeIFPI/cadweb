...
DATABASES = {
   'default': dj_database_url.parse('postgresql://neondb_owner:npg_PrV8Eg4eKGsh@ep-snowy-dew-ac6358uy-pooler.sa-east-1.aws.neon.tech/neondb?sslmode=require')
}
...
# URL padrão para login (quando o usuário não estiver autenticado)
LOGIN_URL = '/login/'

# Para onde o usuário será redirecionado após login bem-sucedido
LOGIN_REDIRECT_URL = '/'

# Para onde o usuário será redirecionado após logout
